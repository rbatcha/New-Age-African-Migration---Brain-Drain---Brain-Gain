...
// Define map variable
var map = L.map('map').setView([1, 1], 2.5);
// Add empty dropdown menu
var legend = L.control({position: 'topright'});
legend.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend');
    div.innerHTML += '<b>Click on Country - <br>(blue proportional symbols)<br> to Display <br>Migration Flow. <br> Click on a year <br> and flow direction<br> to get migration <br>flow pattern IN - OUT <br> of Africa to<br> the rest of the  World </b><hr>';
    ...
    div.innerHTML += '<input type="radio" name="year" value="2005"> 2005<br>';
     div.innerHTML += '<input type="radio" name="year" value="2010"> 2010<br>';
    div.innerHTML += '<input type="radio" name="year" value="2017" checked> 2017<br>';    
    return div;
};
legend.addTo(map);
...
L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
	maxZoom: 19,
    attribution: '&copy; <a href="https://github.com/rbatcha" </a>|| Roseline Batcha || <a href="https://migrationdataportal.org/data?i=stock_abs_&t=2017" </a>|| Migration Data Portal, 2017 || <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
